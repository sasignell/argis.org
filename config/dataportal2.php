...
<p><font size="4"><b>Download Center</b></font></br></p>
...
The <b>preview</b> link will let you view and interact with data before you download.
	...
	<table cellpadding="2" cellspacing="2" style="text-align: center; margin-left: auto; margin-right: auto;">
		...
		echo 	"<tr><td>" . $row['title_of_dataset'] . "</td>
				...
				<td><a style='color:black' href='http://www.aprgis.org:8080/geoserver/wms/kml?layers=" . $row['geoserver_workspace'] . ":" . $row['geoserver_layer'] . "' target='_blank'>KMZ</a></td></tr>";}
...
You can also consume ARGIS data via our <font size="2"><b>WEB MAP SERVICE (WMS)</b></font></span> that delivers layers directly into GIS applications such as ArcGIS, Google Earth, uDig or QGIS.  WMS layers allow you to click on map features to extract attribute information, but you cannot view the entire attribute table at once.</br>
Use this URL, <b>http://aprgis.org:8080/geoserver/ows?service=wms&version=1.1.1&request=GetCapabilities&</b>, to connect to a menu of the ARGIS layers shown on our interactive map.</br>For more information, including how to add our WMS to ArcMap, visit this <a href="http://aprgis.org/index.php?post=use-argis-wms-service-to-add-layers-to-googleearth-arcgis-others">blog post</a></p><br>
