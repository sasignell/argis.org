...
The <b>preview</b> link will let you view and interact with data before you download.
	...
	<table cellpadding="2" cellspacing="2" style="text-align: center; margin-left: auto; margin-right: auto;">
		...
		echo 	"<tr><td>" . $row['title_of_dataset'] . "</td>
				...
				<td><a style='color:black' href='http://www.argis.org:8080/geoserver/wms/kml?layers=" . $row['geoserver_workspace'] . ":" . $row['geoserver_layer'] . "' target='_blank'>KMZ</a></td></tr>";}
...
Use this URL, <b>http://argis.org:8080/geoserver/ows?service=wms&version=1.1.1&request=GetCapabilities&</b>, to connect to a menu of the ARGIS layers shown on our interactive map.</br>For more information, including how to add our WMS to ArcMap, visit this <a href="http://argis.org/index.php?post=use-argis-wms-service-to-add-layers-to-googleearth-arcgis-others">blog post</a></p><br>
