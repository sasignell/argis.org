...
Ext.onReady(function () {
    ...
    campsite = new OpenLayers.Layer.WMS("Campsites", "http://aprgis.org:8080/geoserver/wms", {
    ...
    trailregisters = new OpenLayers.Layer.WMS("Trail Registers", "http://aprgis.org:8080/geoserver/wms", {
