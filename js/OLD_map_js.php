...
function checkDisclaimer() {
    ...
    if (disclaimer == "accepted") {
        ...
        var disclaimerWin = new Ext.Window({
            ...
            border: true,
            closeAction: 'hide',
            html: '<div style="padding: 5px">The data provided on this site is for informational and planning purposes only.<br><br>Absolutely no accuracy or completeness guarantee is implied or intended. All information on this map is subject to such variations and corrections as might result from a complete title search and/or accurate field survey.</div>',
            buttons: [{
...
Ext.onReady(function () {
    ...
    map.addLayers([bingmap,mapquestOSM, OSMterrain, USGSimagery, USGSdrg24k, USGSdrg100k, USGSdrg250k, nysdop11, nysdopLatest, bingsat, binghyb, gmap, gsat, ghyb, gphy, precipAccumulation72hr, precipAccumulation48hr, precipAccumulation24hr, precipAccumulation12hr, precipAccumulation6hr, precipAccumulation3hr, precipAccumulation1hr, surfaceWindVelocity, surfaceWindSpeed, surfaceAirTemp, ridgeRADAR,  landclass2001, landclass2012, blowdown1950, firemap1916, streams, wetlands,lakes, aquaticinvasives, fishsurveylakes, lakechem1984_1987,watershedshuc8, citytown,  blueline, slt, streamflow, trailregisters, terrestrialinvasives, leantos, highlightLayer, layerRuler]);
    ...
    legendPanel = new GeoExt.LegendPanel({
        ...
        items: [],
        bbar: ["<b>Developed by <a style='color:black;' href='http://bryanmcbride.com' target='_blank'>bryanmcbride.com</a></b>"/*, "->", loginoutButton*/]
    });
