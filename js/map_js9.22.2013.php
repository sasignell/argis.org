...
Ext.onReady(function () {
    ...
    campsite = new OpenLayers.Layer.WMS("Campsites", "http://argis.org:8080/geoserver/wms", {
    ...
    trailregisters = new OpenLayers.Layer.WMS("Trail Registers", "http://argis.org:8080/geoserver/wms", {
